...
public class CatalMvcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		produitRepository.save(new Produit("Imprimante HP 1234", 250, 100));
		produitRepository.save(new Produit("PC comppaq", 520, 32));
		produitRepository.save(new Produit("Scanner", 300, 12));
